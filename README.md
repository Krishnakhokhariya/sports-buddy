...
Firestore Database - Events, Users, Requests 
Firebase Notifications - Local event notifications 
React Context API - State management 
Custom Hooks - Popup, Confirmation dialogs 
> No Firebase Storage is use
